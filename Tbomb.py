...
def update():
    try:
        ...
        toolVersion = "NATION BOOMER"
    
    try:
        mainVersion = requests.get("https://github.com/NATIONVK/Nation-pro-.git").text
    except:
...
╚═╝░░╚══╝╚═╝░░╚═╝░░░╚═╝░░░╚═╝░╚════╝░╚═╝░░╚══╝    \033[94m   │".center(columns+15))
    ...
    print("│ \033[95mGitHub : qhttps://github.com/NATIONVK/Nation-pro-.git \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : YEASIEN AHMED             \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
